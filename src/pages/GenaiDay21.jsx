...
const RESOURCES = [
  ...
  },
  {
    ...
    link: { href: '/genai-day-22', label: 'Go to Day 22 →' },
  },
];
...
export default function GenaiDay21() {
    ...
    <div className="day001-page">
      <div className="day001-scale-wrap" ref={scaleRef}>
        <header className="day001-topbar">
          ...
          <Link to="/genai-day-20" className="day001-nav-btn day001-nav-prev">← Day 20</Link>
          <p className="day001-datetime">Agentic AI Day 21</p>
          <Link to="/genai-day-22" className="day001-nav-btn day001-nav-next">Day 22 →</Link>
        </header>
