...
export default function GenaiDay35() {
    ...
    <div className="day001-page">
      <div className="day001-scale-wrap" ref={scaleRef}>
        <header className="day001-topbar">
          ...
          <Link to="/genai-day-34" className="day001-nav-btn day001-nav-prev">← Day 34</Link>
          <p className="day001-datetime">Agentic AI Day 35</p>
          <Link to="/genai-day-36" className="day001-nav-btn day001-nav-next">Day 36 →</Link>
        </header>
