...
const RESOURCES = [
  ...
  },
  {
    ...
    link: { href: '/genai-day-25', label: 'Go to Day 25 →' },
  },
];
...
export default function GenaiDay24() {
    ...
    <div className="day001-page">
      <div className="day001-scale-wrap" ref={scaleRef}>
        <header className="day001-topbar">
          ...
          <Link to="/genai-day-23" className="day001-nav-btn day001-nav-prev">← Day 23</Link>
          <p className="day001-datetime">Agentic AI Day 24</p>
          <Link to="/genai-day-25" className="day001-nav-btn day001-nav-next">Day 25 →</Link>
        </header>
