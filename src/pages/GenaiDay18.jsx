...
const RESOURCES = [
  ...
  },
  {
    ...
    link: { href: '/genai-day-19', label: 'Go to Day 19 →' },
  },
];
...
export default function GenaiDay18() {
    ...
    <div className="day001-page">
      <div className="day001-scale-wrap" ref={scaleRef}>
        <header className="day001-topbar">
          ...
          <Link to="/genai-day-17" className="day001-nav-btn day001-nav-prev">← Day 17</Link>
          <p className="day001-datetime">Agentic AI Day 18</p>
          <Link to="/genai-day-19" className="day001-nav-btn day001-nav-next">Day 19 →</Link>
        </header>
