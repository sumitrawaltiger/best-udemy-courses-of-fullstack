...
const RESOURCES = [
  ...
  },
  {
    ...
    link: { href: '/genai-day-17', label: 'Go to Day 17 →' },
  },
];
...
export default function GenaiDay16() {
    ...
    <div className="day001-page">
      <div className="day001-scale-wrap" ref={scaleRef}>
        <header className="day001-topbar">
          ...
          <Link to="/genai-day-15" className="day001-nav-btn day001-nav-prev">← Day 15</Link>
          <p className="day001-datetime">Agentic AI Day 16</p>
          <Link to="/genai-day-17" className="day001-nav-btn day001-nav-next">Day 17 →</Link>
        </header>
