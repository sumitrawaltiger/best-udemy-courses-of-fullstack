...
export default function GenaiDay05() {
    ...
    <div className="day001-page">
      <div className="day001-scale-wrap" ref={scaleRef}>
        <header className="day001-topbar">
          ...
          <Link to="/genai-day-4" className="day001-nav-btn day001-nav-prev">← Day 4</Link>
          <p className="day001-datetime">Agentic AI Day 5</p>
          <Link to="/genai-day-6" className="day001-nav-btn day001-nav-next">Day 6 →</Link>
        </header>
