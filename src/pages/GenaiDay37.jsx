...
const RESOURCES = [
  ...
  },
  {
    ...
    link: { href: '/genai-day-38', label: 'Go to Day 38 →' },
  },
];
...
export default function GenaiDay37() {
    ...
    <div className="day001-page">
      <div className="day001-scale-wrap" ref={scaleRef}>
        <header className="day001-topbar">
          ...
          <Link to="/genai-day-36" className="day001-nav-btn day001-nav-prev">← Day 36</Link>
          <p className="day001-datetime">Agentic AI Day 37</p>
          <Link to="/genai-day-38" className="day001-nav-btn day001-nav-next">Day 38 →</Link>
        </header>
