...
const LEARNT_TODAY = [
  { title: 'Skill 01 · Agentic AI (Days 1–100)', text: 'Day 1 of the 1,826-day journey. Agentic AI is Skill 01 (1–100), then Skill 02 FastAPI (101–200) → JS (201–300) → TS (301–400) → React (401–500) → Next (501–600) → RN (601–700) → Express (701–800) → Databases (801–900) → NestJS (901–1000) → J2SE → DSA → Spring Boot → Microservices → QualityEngg → AWS → DevOps → DevSecOps → SRE → System Design (ends 16 Sep 2031). NexusAI built daily throughout all 1,826 days' },
      ...
      <div className="day001-scale-wrap" ref={scaleRef}>
        ...
        <div className="day001-hero">
          <div className="day001-hero-left">
            <div className="day001-tags"><span>Agentic AI</span><span>Python Stack</span><span>Skill 01</span><span>Day 1</span></div>
        ...
        <p className="day001-summary">
          Day 1 of 1,826 — the start of <strong>Year 1 · Python Stack</strong> (Days 1–365 · 17 Sep 2026 – 16 Sep 2027).
          ...
          then the journey continues through 4 more years all the way to Day 1,826 (16 Sep 2031).
        </p>
