    ...
    <div className="day001-page">
      <div className="day001-scale-wrap" ref={scaleRef}>
        <header className="day001-topbar">
          ...
          <p className="day001-datetime">Day 1 · 9 Sep 2026</p>
        ...
        <p className="day001-summary">
          ...
          LangGraph, and MCP-based agents. <strong>Skill 02 · Agentic AI</strong> begins Day 101 (18 Dec 2026),
          then the journey continues through 18 more skills all the way to Day 2,000 (29 Feb 2032).
        </p>
