    ...
    <div className="day001-page">
      <div className="day001-scale-wrap" ref={scaleRef}>
        <header className="day001-topbar">
          ...
          <p className="day001-datetime">Day 1 · 1 Jan 2027</p>
        ...
        <p className="day001-summary">
          Day 1 of 2,000 — the start of <strong>Skill 01 · Python</strong> (Days 1–100 · 1 Jan – 10 Apr 2027).
          ...
          LangGraph, and MCP-based agents. <strong>Skill 02 · Agentic AI</strong> begins Day 101 (11 Apr 2027),
          then the journey continues through 18 more skills all the way to Day 2,000 (22 Jun 2032).
        </p>
