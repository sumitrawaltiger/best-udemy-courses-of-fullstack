    ...
    <div className="day001-page">
      <div className="day001-scale-wrap" ref={scaleRef}>
        <header className="day001-topbar">
          ...
          <p className="day001-datetime">Day 1 · 11 Sep 2026</p>
        ...
        <p className="day001-summary">
          Day 1 of 2,000 — the start of <strong>Skill 01 · Python</strong> (Days 1–100 · 11 Sep – 19 Dec 2026).
          ...
          LangGraph, and MCP-based agents. <strong>Skill 02 · Agentic AI</strong> begins Day 101 (20 Dec 2026),
          then the journey continues through 18 more skills all the way to Day 2,000 (2 Mar 2032).
        </p>
