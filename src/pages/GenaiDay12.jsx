...
const RESOURCES = [
  ...
  },
  {
    ...
    link: { href: '/genai-day-13', label: 'Go to Day 13 →' },
  },
];
...
export default function GenaiDay12() {
    ...
    <div className="day001-page">
      <div className="day001-scale-wrap" ref={scaleRef}>
        <header className="day001-topbar">
          ...
          <Link to="/genai-day-11" className="day001-nav-btn day001-nav-prev">← Day 11</Link>
          <p className="day001-datetime">Agentic AI Day 12</p>
          <Link to="/genai-day-13" className="day001-nav-btn day001-nav-next">Day 13 →</Link>
        </header>
