...
const RESOURCES = [
  ...
  },
  {
    ...
    link: { href: '/genai-day-37', label: 'Go to Day 37 →' },
  },
];
...
export default function GenaiDay36() {
    ...
    <div className="day001-page">
      <div className="day001-scale-wrap" ref={scaleRef}>
        <header className="day001-topbar">
          ...
          <Link to="/genai-day-35" className="day001-nav-btn day001-nav-prev">← Day 35</Link>
          <p className="day001-datetime">Agentic AI Day 36</p>
          <Link to="/genai-day-37" className="day001-nav-btn day001-nav-next">Day 37 →</Link>
        </header>
