...
const RESOURCES = [
  ...
  },
  {
    ...
    link: { href: '/genai-day-8', label: 'Go to Day 8 →' },
  },
];
...
export default function GenaiDay07() {
    ...
    <div className="day001-page">
      <div className="day001-scale-wrap" ref={scaleRef}>
        <header className="day001-topbar">
          ...
          <Link to="/genai-day-6" className="day001-nav-btn day001-nav-prev">← Day 6</Link>
          <p className="day001-datetime">Agentic AI Day 7</p>
          <Link to="/genai-day-8" className="day001-nav-btn day001-nav-next">Day 8 →</Link>
        </header>
