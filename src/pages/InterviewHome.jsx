      ...
      <div className="home interview-home">
        ...
        <section className="roadmap">
          ...
          <p className="section-desc">
            Across the <strong>55-month, 1,700-day</strong> roadmap, <strong>DSA</strong> and{' '}
          ...
          <div className="roadmap-legend">
            ...
            <span>
              <span className="legend-dot published" /> DSA & System Design in each language: Python · TypeScript · Java · 55 months · 1,700 days total
            </span>
          </div>
        </section>
