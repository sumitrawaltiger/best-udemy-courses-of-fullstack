      ...
      <div className="home interview-home">
        ...
        <section className="roadmap">
          ...
          <p className="section-desc">
            Across the <strong>66-month, 2,000-day</strong> roadmap, <strong>DSA</strong> and{' '}
          ...
          <div className="roadmap-legend">
            ...
            <span>
              <span className="legend-dot published" /> DSA & System Design in each language: Python · TypeScript · Java · 66 months · 2,000 days total
            </span>
          </div>
        </section>
