      ...
      <div className="home interview-home">
        ...
        <section className="roadmap">
          ...
          <p className="section-desc">
            Across the <strong>5-stack, 1,614-day</strong> roadmap, <strong>DSA</strong> and{' '}
          ...
          <div className="roadmap-legend">
            ...
            <span>
              <span className="legend-dot published" /> DSA & System Design in each language: Python · TypeScript · Java · 1,614 days total
            </span>
          </div>
        </section>
