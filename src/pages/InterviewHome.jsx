      ...
      <div className="home interview-home">
        ...
        <section className="roadmap">
          ...
          <p className="section-desc">
            ...
            (16 Feb – 26 May 2029), a <strong>50 Days React Bootcamp</strong> (27 May – 15 Jul 2029), then{' '}
            <strong>Interview Preparation</strong> for <strong>354 days (~51 weeks)</strong> — 16 Jul 2029 to{' '}
          ...
          <div className="roadmap-legend">
            ...
            <span>
              <span className="legend-dot published" /> SQL 100d · React 50d · IP 354d (~51w) → 4 Jul 2030 · 1461 total
            </span>
          </div>
        </section>
