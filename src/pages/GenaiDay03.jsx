...
const RESOURCES = [
  ...
  },
  {
    ...
    link: { href: '/genai-day-4', label: 'Go to Day 4 →' },
  },
];
...
export default function GenaiDay03() {
    ...
    <div className="day001-page">
      <div className="day001-scale-wrap" ref={scaleRef}>
        <header className="day001-topbar">
          ...
          <Link to="/genai-day-2" className="day001-nav-btn day001-nav-prev">← Day 2</Link>
          <p className="day001-datetime">Agentic AI Day 3</p>
          <Link to="/genai-day-4" className="day001-nav-btn day001-nav-next">Day 4 →</Link>
        </header>
