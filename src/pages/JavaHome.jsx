    ...
    <>
      ...
      <div className="home java-home">
        ...
        <section className="roadmap">
          ...
          <p className="section-desc">
            Path:{' '}
            <strong>J2SE → JPA → DSA → Spring Boot → Microservices</strong> — {javaChapters.length} modules of the
            Java stack.
          </p>
          ...
          <div className="roadmap-legend">
            ...
            <span>
              <span className="legend-dot published" /> J2SE → JPA → DSA → Spring Boot → Microservices
            </span>
          </div>
        </section>
