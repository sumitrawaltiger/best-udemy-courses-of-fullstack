...
const RESOURCES = [
  ...
  },
  {
    ...
    link: { href: '/genai-day-28', label: 'Go to Day 28 →' },
  },
];
...
export default function GenaiDay27() {
    ...
    <div className="day001-page">
      <div className="day001-scale-wrap" ref={scaleRef}>
        <header className="day001-topbar">
          ...
          <Link to="/genai-day-26" className="day001-nav-btn day001-nav-prev">← Day 26</Link>
          <p className="day001-datetime">Agentic AI Day 27</p>
          <Link to="/genai-day-28" className="day001-nav-btn day001-nav-next">Day 28 →</Link>
        </header>
