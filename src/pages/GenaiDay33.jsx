...
const RESOURCES = [
  ...
  },
  {
    ...
    link: { href: '/genai-day-34', label: 'Go to Day 34 →' },
  },
];
...
export default function GenaiDay33() {
    ...
    <div className="day001-page">
      <div className="day001-scale-wrap" ref={scaleRef}>
        <header className="day001-topbar">
          ...
          <Link to="/genai-day-32" className="day001-nav-btn day001-nav-prev">← Day 32</Link>
          <p className="day001-datetime">Agentic AI Day 33</p>
          <Link to="/genai-day-34" className="day001-nav-btn day001-nav-next">Day 34 →</Link>
        </header>
