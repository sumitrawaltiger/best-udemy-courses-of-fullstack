...
const RESOURCES = [
  ...
  },
  {
    ...
    link: { href: '/genai-day-29', label: 'Go to Day 29 →' },
  },
];
...
export default function GenaiDay28() {
    ...
    <div className="day001-page">
      <div className="day001-scale-wrap" ref={scaleRef}>
        <header className="day001-topbar">
          ...
          <Link to="/genai-day-27" className="day001-nav-btn day001-nav-prev">← Day 27</Link>
          <p className="day001-datetime">Agentic AI Day 28</p>
          <Link to="/genai-day-29" className="day001-nav-btn day001-nav-next">Day 29 →</Link>
        </header>
