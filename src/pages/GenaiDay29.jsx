...
const RESOURCES = [
  ...
  },
  {
    ...
    link: { href: '/genai-day-30', label: 'Go to Day 30 →' },
  },
];
...
export default function GenaiDay29() {
    ...
    <div className="day001-page">
      <div className="day001-scale-wrap" ref={scaleRef}>
        <header className="day001-topbar">
          ...
          <Link to="/genai-day-28" className="day001-nav-btn day001-nav-prev">← Day 28</Link>
          <p className="day001-datetime">Agentic AI Day 29</p>
          <Link to="/genai-day-30" className="day001-nav-btn day001-nav-next">Day 30 →</Link>
        </header>
