...
const _CAL_DAY1 = new Date(2026, 7, 28); // 28 Aug 2026
...
// ── 20 skills · 2,000 days (all 20 skills: 100 days each) ────────────────
  ...
  return (
    <div className="roadmap-page">
      <section className="roadmap-hero">
        <span className="roadmap-hero-badge">📍 Day 0 setup · 20 skills · 2,000 days (all 20 skills: 100d each)</span>
        ...
        <p className="roadmap-hero-sub">
          ...
          <strong>20 skills mastered to depth — 66 months (2,000 days)</strong> of focused daily practice,
      ...
      >
        <img
          ...
          alt="20 Skills. 2,000 Days. One Journey. — Full Lifecycle Engineer roadmap: Python → FastAPI → Agentic AI → JavaScript → TypeScript → React JS → Next JS → React Native → Databases → Express JS → J2SE → Spring Boot → Kafka → Microservices → Automation Testing → DevOps → Cloud (AWS) → SRE → System Design → DSA. Day 1: 28 Aug 2026 · Day 2,000: 17 Feb 2032."
          loading="eager"
          style={{
            width: '100%',
            height: 'auto',
      ...
      <section style={{ maxWidth: '780px', margin: '16px auto 8px', padding: '0 12px' }}>
        ...
        <p style={{ textAlign: 'center', color: '#6b7b8e', fontSize: '0.75rem', marginTop: '10px' }}>
          Day 1 = 28 Aug 2026 · 20 skills · 2,000 days · journey ends 17 Feb 2032
        </p>
      </section>
      ...
      <div className="roadmap-timeline">
        ...
        <div className="roadmap-finish">
          ...
          <div>
            ...
            <p className="roadmap-finish-date">20 skills · 2,000 days (all 20 skills: 100d each), front to back</p>
          </div>
        </div>
      </div>
        ...
        <div style={{
          ...
          <div>
            ...
            <p style={{ color: '#fff', fontWeight: 700, fontSize: '0.88rem', marginBottom: '10px' }}>
              Target: 17 Feb 2032 · Day 2,000
            </p>
            <p style={{ color: 'rgba(200,212,224,0.82)', fontSize: '0.82rem', lineHeight: 1.65, marginBottom: '12px' }}>
              1 LeetCode daily challenge every single day — Day 1 (28 Aug 2026) through Day 2,000 (17 Feb 2032).
      ...
      <section className="roadmap-flow">
        ...
        <p className="roadmap-flow-text">
          ...
          NexusAI capstone built daily throughout. 66 months (2,000 days) end to end.
        </p>
