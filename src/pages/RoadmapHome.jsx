    ...
    <div className="roadmap-page">
      ...
      >
        <img
          ...
          alt="21 Skills. 2,100 Days. One Journey. — Full Lifecycle Engineer roadmap: Python → FastAPI → Agentic AI → JavaScript → TypeScript → React JS → Next JS → React Native → Databases → Express JS → J2SE → JPA → Spring Boot → Microservices → Automation Testing → DevOps → Cloud (AWS) → SRE → System Design → DSA. Day 1: 24 Aug 2026 · Day 2,000: 13 Feb 2032."
          loading="eager"
          style={{
            width: '100%',
            height: 'auto',
      ...
      <section style={{ maxWidth: '780px', margin: '16px auto 8px', padding: '0 12px' }}>
        ...
        <p style={{ textAlign: 'center', color: '#6b7b8e', fontSize: '0.75rem', marginTop: '10px' }}>
          Day 1 = 24 Aug 2026 · 20 skills · 2,000 days · journey ends 13 Feb 2032
        </p>
      </section>
