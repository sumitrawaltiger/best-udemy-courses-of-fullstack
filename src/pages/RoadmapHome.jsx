...
export default function RoadmapHome() {
  return (
    <div className="roadmap-page">
      ...
      >
        <img
          src="/roadmap-notes/1616-days-learning-journey-2026-2030-v2.png"
          alt="1616 Days Learning Journey — 30th July 2026 to 31st December 2030 (4 years, 5 months, 2 days), one goal: 1. Agentic AI Using Python (30 Jul – 31 Dec 2026, 155 days) — Build Intelligent Agents, Automate, Orchestrate, Innovate. AI agent concepts & architecture, LangChain fundamentals, LangGraph & agent workflows, MCP (Model Context Protocol), n8n agentic workflows, real AI agent projects; tools: LangChain, LangGraph, MCP, n8n, Agentic Workflows. 2. Python Stack (Jan – 31 Dec 2027, 365 days) — Leverage Python for Data, AI, Automation & Backend. Advanced Python programming, data structures & algorithms, data analysis (Pandas, NumPy), machine learning basics, FastAPI & REST APIs, automation & scripting; tools: Python, Pandas, NumPy, FastAPI, Scikit-learn, SQL, Scripting. 3. TypeScript Stack (Jan – 31 Dec 2028, 366 days) — Build Scalable, Performant & Modern Web Applications. TypeScript fundamentals & advanced types, React + TypeScript, Next.js & App Router, React Native, state management (Redux/Zustand), Express.js & Node.js, testing/performance/best practices; tools: TypeScript, React, Next.js, React Native, Node.js, Express, Redux, Zustand. 4. Java Stack (1 Jan – 31 Dec 2029, 365 days) — Master Enterprise Backend Development with Java. Core Java & OOPs, collections & multithreading, Spring Boot & Spring Framework, REST APIs & microservices, JPA/Hibernate & databases, microservices architecture, testing/logging/security; tools: Java, Spring Boot, JPA, Hibernate, Microservices, Docker, Kafka. 5. DevOps Stack (Jan – 31 Dec 2030, 365 days) — Automate, Deploy, Monitor & Scale with Confidence. Linux administration, Docker & containerization, Kubernetes orchestration, CI/CD pipelines (Jenkins/GitHub Actions), infrastructure as code (Terraform), monitoring & logging (Prometheus, Grafana), AWS cloud fundamentals; tools: Linux, Docker, Kubernetes, CI/CD, Terraform, AWS, Monitoring. One goal: become a Full-Stack Engineer — build, deploy, automate, scale; write code, solve problems, make impact. Note: Agentic AI and the Python Stack together form one continuous Python Stack phase (520 days) on this site's roadmap."
          loading="lazy"
          style={{
            width: '100%',
            height: 'auto',
