...
const _CAL_DAY1 = new Date(2026, 7, 25); // 25 Aug 2026
    ...
    <div className="roadmap-page">
      ...
      <section style={{ maxWidth: '780px', margin: '16px auto 8px', padding: '0 12px' }}>
        ...
        <p style={{ textAlign: 'center', color: '#6b7b8e', fontSize: '0.75rem', marginTop: '10px' }}>
          Day 1 = 25 Aug 2026 · 20 skills · 2,000 days · journey ends 14 Feb 2032
        </p>
      </section>
        ...
        <div style={{
          ...
          <div>
            ...
            <p style={{ color: 'rgba(200,212,224,0.82)', fontSize: '0.82rem', lineHeight: 1.65, marginBottom: '12px' }}>
              1 LeetCode daily challenge every single day — Day 1 (25 Aug 2026) through Day 2,000 (14 Feb 2032).
