...
export default function RoadmapHome() {
  return (
    <div className="roadmap-page">
      ...
      >
        <img
          src="/roadmap-notes/53-months-learning-journey-2026-2030.jpg"
          alt="53 Months Learning Journey — 1st August 2026 to 31st December 2030, 5 stacks, one goal: 1. Agentic AI using Python (Aug–Dec 2026, 5 months) — AI agent concepts & architecture, LangChain fundamentals, LangGraph & agent workflows, MCP, n8n agentic workflows, real AI agent projects; tools: LangChain, LangGraph, MCP, n8n, Agentic Workflows. 2. TypeScript Stack (2027, 12 months) — TypeScript fundamentals & advanced types, React + TypeScript, Next.js & App Router, React Native, state management (Redux/Zustand), Express.js & Node.js, testing/performance/best practices; tools: TypeScript, React, Next.js, React Native, Node.js, Express, Redux, Zustand. 3. Java Stack (2028, 12 months) — core Java & OOPs, collections & multithreading, Spring Boot & Spring Framework, REST APIs & microservices, JPA/Hibernate & databases, microservices architecture, testing/logging/security; tools: Java, Spring Boot, JPA, Hibernate, Microservices, Docker, Kafka. 4. Python Stack (2029, 12 months) — advanced Python programming, data structures & algorithms, data analysis (Pandas, NumPy), machine learning basics, FastAPI & REST APIs, automation & scripting; tools: Python, Pandas, NumPy, FastAPI, Scikit-learn, SQL, Scripting. 5. DevOps Stack (2030, 12 months) — Linux administration, Docker & containerization, Kubernetes orchestration, CI/CD pipelines (Jenkins/GitHub Actions), infrastructure as code (Terraform), monitoring & logging (Prometheus, Grafana), AWS cloud fundamentals; tools: Linux, Docker, Kubernetes, CI/CD, Terraform, AWS, Monitoring. One goal: become a Full-Stack Engineer — build, deploy, automate, scale; write code, solve problems, make impact."
          loading="lazy"
          style={{
            width: '100%',
            height: 'auto',
