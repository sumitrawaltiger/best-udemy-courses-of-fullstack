...
const learntToday = [
  ...
  { title: '147 days remain', text: 'Agentic AI continues through Day 300 (8 Jun 2027) — deeper agent work, new tools, and production-grade pipelines ahead' },
...
const core = [
  ...
  },
  {
    ...
    description: 'Day 153 is a capstone checkpoint — 147 days of Agentic AI remain through Day 300 (8 Jun 2027). Deeper agent work, new tools, and multi-language pipelines ahead.',
...
const resources = [
  {
    ...
    description: 'The Agentic AI journal continues through Day 300 (8 Jun 2027) — deeper topics, more tools, production pipelines.',
...
export default function AgenticDay153() {
  return (
    <StandaloneJourneyPage
      dayNumber={153}
      series="Agentic AI"
      dateLabel="Agentic AI Day 153 · 24 Jan 2027"
      ...
      summary={
        <>
          ...
          Tag your repo, share the progress once — <strong>Agentic AI continues through Day 300 (8 Jun 2027)</strong>,{' '}
