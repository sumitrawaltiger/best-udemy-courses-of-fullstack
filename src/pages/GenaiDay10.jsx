...
export default function GenaiDay10() {
    ...
    <div className="day001-page">
      <div className="day001-scale-wrap" ref={scaleRef}>
        <header className="day001-topbar">
          ...
          <Link to="/genai-day-9" className="day001-nav-btn day001-nav-prev">← Day 9</Link>
          <p className="day001-datetime">Agentic AI Day 10</p>
          <Link to="/genai-day-11" className="day001-nav-btn day001-nav-next">Day 11 →</Link>
        </header>
