...
const RESOURCES = [
  ...
  },
  {
    ...
    link: { href: '/genai-day-27', label: 'Go to Day 27 →' },
  },
];
...
export default function GenaiDay26() {
    ...
    <div className="day001-page">
      <div className="day001-scale-wrap" ref={scaleRef}>
        <header className="day001-topbar">
          ...
          <Link to="/genai-day-25" className="day001-nav-btn day001-nav-prev">← Day 25</Link>
          <p className="day001-datetime">Agentic AI Day 26</p>
          <Link to="/genai-day-27" className="day001-nav-btn day001-nav-next">Day 27 →</Link>
        </header>
