...
const RESOURCES = [
  ...
  },
  {
    ...
    link: { href: '/genai-day-5', label: 'Go to Day 5 →' },
  },
];
...
export default function GenaiDay04() {
    ...
    <div className="day001-page">
      <div className="day001-scale-wrap" ref={scaleRef}>
        <header className="day001-topbar">
          ...
          <Link to="/genai-day-3" className="day001-nav-btn day001-nav-prev">← Day 3</Link>
          <p className="day001-datetime">Agentic AI Day 4</p>
          <Link to="/genai-day-5" className="day001-nav-btn day001-nav-next">Day 5 →</Link>
        </header>
