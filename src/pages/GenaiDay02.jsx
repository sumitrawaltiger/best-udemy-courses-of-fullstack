...
const RESOURCES = [
  ...
  },
  {
    ...
    link: { href: '/genai-day-3', label: 'Go to Day 3 →' },
  },
];
...
export default function GenaiDay02() {
    ...
    <div className="day001-page">
      <div className="day001-scale-wrap" ref={scaleRef}>
        <header className="day001-topbar">
          ...
          <Link to="/genai-day-1" className="day001-nav-btn day001-nav-prev">← Day 1</Link>
          <p className="day001-datetime">Agentic AI Day 2</p>
          <Link to="/genai-day-3" className="day001-nav-btn day001-nav-next">Day 3 →</Link>
        </header>
