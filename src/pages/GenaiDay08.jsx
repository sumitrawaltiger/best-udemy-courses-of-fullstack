...
const RESOURCES = [
  ...
  },
  {
    ...
    link: { href: '/genai-day-9', label: 'Go to Day 9 →' },
  },
];
...
export default function GenaiDay08() {
    ...
    <div className="day001-page">
      <div className="day001-scale-wrap" ref={scaleRef}>
        <header className="day001-topbar">
          ...
          <Link to="/genai-day-7" className="day001-nav-btn day001-nav-prev">← Day 7</Link>
          <p className="day001-datetime">Agentic AI Day 8</p>
          <Link to="/genai-day-9" className="day001-nav-btn day001-nav-next">Day 9 →</Link>
        </header>
