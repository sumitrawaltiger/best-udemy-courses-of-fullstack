...
const RESOURCES = [
  ...
  },
  {
    ...
    link: { href: '/genai-day-15', label: 'Go to Day 15 →' },
  },
];
...
export default function GenaiDay14() {
    ...
    <div className="day001-page">
      <div className="day001-scale-wrap" ref={scaleRef}>
        <header className="day001-topbar">
          ...
          <Link to="/genai-day-13" className="day001-nav-btn day001-nav-prev">← Day 13</Link>
          <p className="day001-datetime">Agentic AI Day 14</p>
          <Link to="/genai-day-15" className="day001-nav-btn day001-nav-next">Day 15 →</Link>
        </header>
