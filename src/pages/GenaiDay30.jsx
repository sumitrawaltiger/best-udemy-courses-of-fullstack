...
export default function GenaiDay30() {
    ...
    <div className="day001-page">
      <div className="day001-scale-wrap" ref={scaleRef}>
        <header className="day001-topbar">
          ...
          <Link to="/genai-day-29" className="day001-nav-btn day001-nav-prev">← Day 29</Link>
          <p className="day001-datetime">Agentic AI Day 30</p>
          <Link to="/genai-day-31" className="day001-nav-btn day001-nav-next">Day 31 →</Link>
        </header>
