...
export default function GenaiDay15() {
    ...
    <div className="day001-page">
      <div className="day001-scale-wrap" ref={scaleRef}>
        <header className="day001-topbar">
          ...
          <Link to="/genai-day-14" className="day001-nav-btn day001-nav-prev">← Day 14</Link>
          <p className="day001-datetime">Agentic AI Day 15</p>
          <Link to="/genai-day-16" className="day001-nav-btn day001-nav-next">Day 16 →</Link>
        </header>
