...
const SETUP_CHECKLIST = [
  ...
  },
  {
    ...
    text: 'Day 1 (25 Aug 2026) starts with Skill 1: Python — core syntax, OOP, file I/O, database connectivity, and multithreading. 100 days (Days 1–100, ends 2 Dec 2026) to master the language foundation',
  },
  {
  ...
  },
  {
    ...
    text: '1 LeetCode daily challenge every single day — Day 1 (25 Aug 2026) through Day 2,000 (14 Feb 2032) earns the LeetCode 2,000 Days Badge. The streak begins tomorrow',
  },
  {
...
const STUDY_SYSTEM = [
  ...
  },
  {
    ...
    titleClass: 'card-title-lime',
    subtitle: 'Days 1–100 · 25 Aug 2026 – 2 Dec 2026',
    description:
      'Day 1 (25 Aug 2026) begins with Skill 1: Python — 100 days of core syntax, OOP, file I/O, database connectivity, and multithreading. Then FastAPI (Days 101–200, 3 Dec 2026 – 12 Mar 2027), then Agentic AI with LangChain, LangGraph, MCP (Days 201–300). NexusAI capstone built in parallel from Day 1.',
    ...
    <div className="day001-page">
      <div className="day001-scale-wrap" ref={scaleRef}>
        <header className="day001-topbar">
          ...
          <p className="day001-datetime">Day 0 · 24 Aug 2026</p>
        ...
        <div className="day001-hero">
          <div className="day001-hero-left">
            <div className="day001-tags">
              ...
              <span>Day 0 · 24 Aug 2026</span>
            </div>
            <div className="day001-title-block">
              <h1 className="day001-day-num">
                DAY 0 <span aria-hidden="true">🛠️</span>
              </h1>
              <p className="day001-day-theme">ENVIRONMENT SETUP · PYTHON STACK + NEXUSAI CAPSTONE BEGINS 23 AUG 2026</p>
            </div>
          </div>
        ...
        <p className="day001-summary">
          <strong>Day 0 · 24 Aug 2026 — environment setup before the 5-year journey begins.</strong>{' '}
          ...
          clear every obstacle so <strong>Day 1 (25 Aug 2026)</strong> starts with zero friction:{' '}
          ...
          <div style={{
            ...
            <div>
              ...
              <p style={{ color: '#fff', fontWeight: 700, fontSize: '0.88rem', marginBottom: '10px' }}>
                Target: 14 Feb 2032 · Saturday · Day 2,000
              </p>
              <p style={{ color: 'rgba(200,210,220,0.8)', fontSize: '0.78rem', lineHeight: 1.6, marginBottom: '10px' }}>
                1 LeetCode problem every single day — Day 1 (25 Aug 2026) through Day 2,000 (14 Feb 2032).
