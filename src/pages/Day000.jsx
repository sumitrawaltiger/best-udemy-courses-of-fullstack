...
const SETUP_CHECKLIST = [
  ...
  {
    title: 'Git & GitHub',
    text: 'installed Git, set my name/email, and created a GitHub account to version and back up all 1620 days of code',
  },
  {
    title: 'VS Code',
  ...
  {
    title: 'The roadmap',
    text: 'reviewed the full 1,620-day plan — 5 sequential stacks: Agentic AI using Python, then the TypeScript Stack (JavaScript, TypeScript, React, Next.js, React Native, Express/Node), the Java Stack (J2SE through Microservices), the Python Stack (Python, FastAPI), and the DevOps Stack (DevOps, AWS Cloud)',
  },
  {
...
const CORE_TOOLS = [
  ...
  },
  {
    ...
    description:
      'Git tracks every change and lets you push code to GitHub. Set your identity once so every commit across 1620 days is signed to you.',
...
const STUDY_SYSTEM = [
  {
    ...
    description:
      'Wake at 4:00 AM, then study 5:00–8:00 AM IST (UTC+5:30) — 3 focused hours, 7 days a week. Same slot every day builds the habit that finishes 1620 days.',
    footer: '+ Consistency today, mastery tomorrow, freedom forever.',
  },
  {
    icon: '🗺️',
    title: 'The 1620-Day Roadmap',
    titleClass: 'card-title-cyan',
    ...
    <div className="day001-page">
      <div className="day001-scale-wrap" ref={scaleRef}>
        ...
        <div className="day001-hero">
          ...
          <div className="day001-profile">
            ...
            <div>
              ...
              <p className="day001-profile-role">1620 DAYS · DAY 0</p>
            </div>
          </div>
        </div>
        ...
        <p className="day001-summary">
          <strong>Day 0 of the 1,620-day learning journey</strong>. Today is only{' '}
