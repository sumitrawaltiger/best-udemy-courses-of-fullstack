...
const RESOURCES = [
  ...
  {
    icon: '🔜', title: 'Next: In C++', titleClass: 'card-title-amber', subtitle: 'Day 33 Preview',
    description:
    ...
    link: { href: '/genai-day-33', label: 'Go to Day 33 →' },
  },
];
...
export default function GenaiDay32() {
    ...
    <div className="day001-page">
      <div className="day001-scale-wrap" ref={scaleRef}>
        <header className="day001-topbar">
          ...
          <Link to="/genai-day-31" className="day001-nav-btn day001-nav-prev">← Day 31</Link>
          <p className="day001-datetime">Agentic AI Day 32</p>
          <Link to="/genai-day-33" className="day001-nav-btn day001-nav-next">Day 33 →</Link>
        </header>

        <div className="day001-hero">
          <div className="day001-hero-left">
            <div className="day001-tags"><span>Agentic AI</span><span>Coder Army</span><span>Lecture 32</span></div>
