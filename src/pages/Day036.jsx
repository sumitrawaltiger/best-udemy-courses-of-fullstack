    ...
    <div className="day001-page">
      <div className="day001-scale-wrap" ref={scaleRef}>
        <header className="day001-topbar">
          ...
          <p className="day001-datetime">TypeScript Day 36</p>
        ...
        <p className="day001-summary">
          ...
          <code>.env</code> — then <strong>deploy</strong> to Render/Railway/Fly, set the env vars and run{' '}
          <code>prisma migrate deploy</code>. <em>The Year-1 stack is built — next: DSA in TypeScript.</em>
        </p>
