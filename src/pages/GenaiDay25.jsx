...
export default function GenaiDay25() {
    ...
    <div className="day001-page">
      <div className="day001-scale-wrap" ref={scaleRef}>
        <header className="day001-topbar">
          ...
          <Link to="/genai-day-24" className="day001-nav-btn day001-nav-prev">← Day 24</Link>
          <p className="day001-datetime">Agentic AI Day 25</p>
          <Link to="/genai-day-26" className="day001-nav-btn day001-nav-next">Day 26 →</Link>
        </header>
