...
const RESOURCES = [
  ...
  },
  {
    ...
    link: { href: '/genai-day-20', label: 'Go to Day 20 →' },
  },
];
...
export default function GenaiDay19() {
    ...
    <div className="day001-page">
      <div className="day001-scale-wrap" ref={scaleRef}>
        <header className="day001-topbar">
          ...
          <Link to="/genai-day-18" className="day001-nav-btn day001-nav-prev">← Day 18</Link>
          <p className="day001-datetime">Agentic AI Day 19</p>
          <Link to="/genai-day-20" className="day001-nav-btn day001-nav-next">Day 20 →</Link>
        </header>
