...
const RESOURCES = [
  ...
  },
  {
    ...
    link: { href: '/genai-day-14', label: 'Go to Day 14 →' },
  },
];
...
export default function GenaiDay13() {
    ...
    <div className="day001-page">
      <div className="day001-scale-wrap" ref={scaleRef}>
        <header className="day001-topbar">
          ...
          <Link to="/genai-day-12" className="day001-nav-btn day001-nav-prev">← Day 12</Link>
          <p className="day001-datetime">Agentic AI Day 13</p>
          <Link to="/genai-day-14" className="day001-nav-btn day001-nav-next">Day 14 →</Link>
        </header>
