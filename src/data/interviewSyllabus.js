...
export const INTERVIEW_META = {
  ...
  description:
    "System Design is practiced every year in that year's language — first in JavaScript (4 Jun – 23 Jul 2027), then Python (Year 2) and Java (Year 3). Following GeeksForGeeks' 12-week, 24-module live program plus ChaiCode: scalability foundations, databases & caching, messaging/events & API design, microservices, resilience, observability & security, cloud/DevOps, and real-world case studies (URL shortener → WhatsApp → Instagram → Uber) with production-grade capstone builds.",
  ...
  totalModules: 60,
  calendarDays: 100,
  phaseWindow: 'Each year · JavaScript first (Days 316–365 · 4 Jun – 23 Jul 2027)',
  startsAfter: 'DSA in JavaScript (through 3 Jun 2027)',
  endsOn: '23 Jul 2027 (JS) · repeats each year in that language',
  continuesWith: 'Year 2 · Python stack (from 24 Jul 2027)',
  focusAreas: [
...
export const DSA_META = {
  ...
  description:
    'DSA is practiced every year in that year’s language — first in JavaScript (24 Feb – 3 Jun 2027, Elshad Karimov’s 100 Days of Code: JS DSA), then Python (Year 2) and Java (Year 3). Arrays, trees, graphs, DP, and problem-solving patterns with GeeksForGeeks Self Paced and ChaiCode practice.',
  gfgDsaUrl: GFG_DSA_URL,
  chaicodeUrl: CHAICODE_INTERVIEW_URL,
  gfgCoursesUrl: GFG_COURSES_URL,
  calendarDays: 100,
  phaseWindow: 'Each year · JavaScript first (Days 216–315 · 24 Feb – 3 Jun 2027)',
  startsAfter: 'Express / Node.js (through 23 Feb 2027)',
  endsOn: '3 Jun 2027 (JS) · repeats each year in that language',
  continuesWith: 'System Design in JavaScript · 4 Jun – 23 Jul 2027',
...
export const JS_DSA_META = {
  ...
  description:
    "From 7 Mar 2029 to 14 Jun 2029: 100 Days of Code — JavaScript Data Structures & Algorithms from zero to hero, with 100+ LeetCode / FAANG-style interview questions, Big-O analysis, and daily hands-on exercises. Following Elshad Karimov's \"100 Days of Code: JavaScript Data Structures and Algorithms\" (Udemy). Carved from the interview-preparation window; a 50 Days React Bootcamp then follows from 15 Jun 2029.",
  courseUrl: 'https://www.udemy.com/course/javascript-data-structures-and-algorithms/',
  instructor: 'Elshad Karimov',
  provider: 'Udemy',
  calendarDays: 100,
  phaseWindow: 'Days 959–1058 · 7 Mar – 14 Jun 2029',
  startsAfter: 'Data Structures (through 6 Mar 2029)',
  endsOn: '14 Jun 2029',
  continuesWith: 'React Bootcamp — 50 Days · 15 Jun – 3 Aug 2029',
...
export const REACT_BOOTCAMP_META = {
  ...
  description:
    "From 15 Jun 2029 to 3 Aug 2029: a 50-day React project bootcamp — build 50 real-world React apps with Hooks, REST APIs, Socket, Firebase, and Bootstrap. Following Sufa Digital's \"50 Days React Bootcamp: Build 50 Real World React Projects\" (Udemy). Carved from the interview-preparation window; a 100 Days of Python bootcamp then follows from 4 Aug 2029.",
  courseUrl: 'https://www.udemy.com/course/build-real-world-application-projects-using-react/',
  instructor: 'Sufa Digital',
  provider: 'Udemy',
  calendarDays: 50,
  phaseWindow: 'Days 1059–1108 · 15 Jun – 3 Aug 2029',
  startsAfter: 'JavaScript DSA — 100 Days (through 14 Jun 2029)',
  endsOn: '3 Aug 2029',
  continuesWith: 'Python Bootcamp — 100 Days of Code · 4 Aug – 11 Nov 2029',
...
export const PYTHON_BOOTCAMP_META = {
  ...
  description:
    "From 4 Aug 2029 to 11 Nov 2029: a 100-day Python pro bootcamp — build 100 projects across automation, web dev, data science, and games with Flask, Selenium, Beautiful Soup, Pandas, NumPy, and more. Following Dr. Angela Yu's \"100 Days of Code: The Complete Python Pro Bootcamp\" (Udemy — 52 hours). Carved from the interview-preparation window; a 100 Days of JavaScript bootcamp then follows from 12 Nov 2029.",
  courseUrl: 'https://www.udemy.com/course/100-days-of-code/',
  instructor: 'Dr. Angela Yu',
  provider: 'Udemy',
  calendarDays: 100,
  phaseWindow: 'Days 1109–1208 · 4 Aug – 11 Nov 2029',
  startsAfter: 'React Bootcamp — 50 Days (through 3 Aug 2029)',
  endsOn: '11 Nov 2029',
  continuesWith: 'JavaScript Bootcamp — 100 Days of JavaScript · 12 Nov 2029 – 19 Feb 2030',
...
export const JS_BOOTCAMP_META = {
  ...
  description:
    "From 12 Nov 2029 to 19 Feb 2030: a 100-day JavaScript project bootcamp — sharpen JS skills by building projects with HTML, CSS, Flexbox, Grid, Bootstrap, ES6 classes, arrow functions, events, and DOM manipulation. Following Ewomazino Akpareva's \"100 Days of JavaScript\" (Udemy — 60.5 hours). Carved from the interview-preparation window; a 50 Days LeetCode in Java phase then follows from 20 Feb 2030.",
  courseUrl: 'https://www.udemy.com/course/100-days-of-javascript/',
  instructor: 'Ewomazino Akpareva',
  provider: 'Udemy',
  calendarDays: 100,
  phaseWindow: 'Days 1209–1308 · 12 Nov 2029 – 19 Feb 2030',
  startsAfter: 'Python Bootcamp — 100 Days (through 11 Nov 2029)',
  endsOn: '19 Feb 2030',
  continuesWith: 'LeetCode in Java — 50 Days · 20 Feb 2030 – 10 Apr 2030',
...
export const LEETCODE_JAVA_META = {
  ...
  description:
    "From 20 Feb 2030 to 10 Apr 2030: a 50-day LeetCode grind in Java — algorithms, data structures, and the coding-interview questions companies ask, solved and explained step by step. Following Holczer Balazs's \"LeetCode in Java: Algorithms Coding Interview Questions\" (Udemy). Carved from the interview-preparation window; a 60 Days Java Masterclass then follows from 11 Apr 2030.",
  courseUrl: 'https://www.udemy.com/course/leetcode-in-java-algorithms-coding-interview-questions/',
  instructor: 'Holczer Balazs',
  provider: 'Udemy',
  calendarDays: 50,
  phaseWindow: 'Days 1309–1358 · 20 Feb – 10 Apr 2030',
  startsAfter: 'JavaScript Bootcamp — 100 Days (through 19 Feb 2030)',
  endsOn: '10 Apr 2030',
  continuesWith: 'Java Masterclass — 60 Days of Java · 11 Apr 2030 – 9 Jun 2030',
...
export const JAVA_MASTERCLASS_META = {
  ...
  description:
    "From 11 Apr 2030 to 9 Jun 2030: a 60-day complete Java masterclass — master Java from basics to advanced, OOP principles, JavaFX desktop apps, Spring Boot web apps & microservices, REST APIs, and file/database handling with Spring Data & H2. Following Denis Panjuta's \"60 Days of Java: The Complete Java Masterclass\" (Udemy — 49.5 hours). Carved from the interview-preparation window; a 30 JavaScript Projects in 30 Days phase then follows from 10 Jun 2030.",
  courseUrl: 'https://www.udemy.com/course/javamasterclass/',
  instructor: 'Denis Panjuta',
  provider: 'Udemy',
  calendarDays: 60,
  phaseWindow: 'Days 1359–1418 · 11 Apr – 9 Jun 2030',
  startsAfter: 'LeetCode in Java — 50 Days (through 10 Apr 2030)',
  endsOn: '9 Jun 2030',
  continuesWith: 'JS Projects — 30 JavaScript Projects in 30 Days · 10 Jun 2030 – 9 Jul 2030',
...
export const JS_PROJECTS_META = {
  ...
  description:
    "From 10 Jun 2030 to 9 Jul 2030: a 30-day project sprint — build 30 unique real-world apps from scratch and grow a web-developer portfolio, strengthening core JavaScript, HTML, and CSS skills. Following Course Max One's \"30 JavaScript Projects in 30 Days – HTML, CSS & JS\" (Udemy — 6.5 hours). Carved from the interview-preparation window; a Two-Week JavaScript Bootcamp then closes the journey from 10 Jul 2030.",
  courseUrl: 'https://www.udemy.com/course/30-javascript-projects-in-30-days/',
  instructor: 'Course Max One',
  provider: 'Udemy',
  calendarDays: 30,
  phaseWindow: 'Days 1419–1448 · 10 Jun – 9 Jul 2030',
  startsAfter: 'Java Masterclass — 60 Days (through 9 Jun 2030)',
  endsOn: '9 Jul 2030',
  continuesWith: 'Two-Week JavaScript Bootcamp — 14 days · 10 Jul 2030 – 23 Jul 2030',
...
export const JS_TWO_WEEK_META = {
  ...
  description:
    "From 10 Jul 2030 to 23 Jul 2030: a two-week JavaScript bootcamp that closes the 4-year journey — JavaScript from the very beginning to an advanced level: data types, conditionals, loops, functions, arrays, objects, the DOM, events, and forms, with hands-on projects. Following Fabian & Pavel Coding2GO's \"Learn JavaScript in 2 Weeks (Complete JavaScript Bootcamp)\" (Udemy). This final 14-day phase consumes the last of the old interview-preparation window and completes 1461 days of study from 24 Jul 2026 to 23 Jul 2030.",
  courseUrl: 'https://www.udemy.com/course/javascript-course-coding2go/',
  instructor: 'Fabian & Pavel Coding2GO',
  provider: 'Udemy',
  calendarDays: 14,
  weeks: 2,
  phaseWindow: 'Days 1449–1462 · 10 Jul – 23 Jul 2030',
  startsAfter: 'JS Projects — 30 Days (through 9 Jul 2030)',
  endsOn: '23 Jul 2030',
  journey: '1461 days · 4 years · 24 Jul 2026 → 23 Jul 2030',
...
export const JOURNEY_META = {
  ...
  startLabel: '24 Jul 2026',
  endLabel: '23 Jul 2030',
  years: 4,
  totalDays: 1461,
  finalPhaseDays: 14,
  finalPhaseWeeks: 2,
