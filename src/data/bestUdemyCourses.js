...
export const BEST_COURSES = [
  ...
  },
  {
    ...
    provider: 'Udemy',
    note: 'A 100-day JavaScript DSA phase (carved from the interview-prep window) — data structures & algorithms from zero to hero with 100+ LeetCode / FAANG-style interview questions and Big-O analysis. 4.6★.',
    links: [
      {
        label: 'View on Udemy',
  ...
  },
  {
    ...
    provider: 'Udemy',
    note: 'A 50-day React project bootcamp (carved from the interview-prep window) — build 50 real-world React apps with Hooks, REST APIs, Socket, Firebase, and Bootstrap.',
    links: [
      {
        label: 'View on Udemy',
  ...
  },
  {
    ...
    provider: 'Udemy',
    note: 'A 100-day Python pro bootcamp (carved from the interview-prep window) — build 100 projects across automation, web dev (Flask), data science (Pandas/NumPy), and games. 52 hours, Bestseller.',
    links: [
      {
        label: 'View on Udemy',
  ...
  },
  {
    ...
    provider: 'Udemy',
    note: 'A 100-day JavaScript project bootcamp (carved from the interview-prep window) — sharpen JS skills by building projects with HTML, CSS, Flexbox, Grid, Bootstrap, ES6 classes, and DOM manipulation. 60.5 hours.',
    links: [
      {
        label: 'View on Udemy',
  ...
  },
  {
    ...
    provider: 'Udemy',
    note: 'A 50-day LeetCode grind in Java (carved from the interview-prep window) — algorithms, data structures, and the coding-interview questions companies ask, solved and explained step by step.',
    links: [
      {
        label: 'View on Udemy',
  ...
  },
  {
    ...
    provider: 'Udemy',
    note: 'A 60-day complete Java masterclass (carved from the interview-prep window) — master Java from basics to advanced with OOP, JavaFX desktop apps, Spring Boot, REST APIs, microservices, and database handling. 49.5 hours.',
    links: [
      {
        label: 'View on Udemy',
  ...
  },
  {
    ...
    provider: 'Udemy',
    note: 'A 30-day project sprint (carved from the interview-prep window) — build 30 unique real-world apps from scratch and grow a web-developer portfolio while strengthening core JavaScript, HTML, and CSS. 6.5 hours.',
    links: [
      {
        label: 'View on Udemy',
  ...
  },
  {
    ...
    provider: 'Udemy',
    note: 'The final phase of the journey (14 days) — JavaScript from the very beginning to advanced: data types, loops, functions, arrays, objects, the DOM, events, forms, and hands-on projects.',
    links: [
      {
        label: 'View on Udemy',
