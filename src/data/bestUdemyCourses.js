...
export const BEST_COURSES = [
  ...
  },
  {
    ...
    provider: 'Udemy',
    note: 'A 100-day JavaScript DSA phase (16 Feb – 26 May 2029, carved from the interview-prep window) — data structures & algorithms from zero to hero with 100+ LeetCode / FAANG-style interview questions and Big-O analysis. 4.6★.',
    links: [
      {
        label: 'View on Udemy',
  ...
  },
  {
    ...
    provider: 'Udemy',
    note: 'The final phase of the journey (21 Jun – 4 Jul 2030, 14 days) — JavaScript from the very beginning to advanced: data types, loops, functions, arrays, objects, the DOM, events, forms, and hands-on projects.',
    links: [
      {
        label: 'View on Udemy',
