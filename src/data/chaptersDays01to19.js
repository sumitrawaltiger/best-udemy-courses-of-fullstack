...
export const chaptersDays01to19 = [
  {
    ...
    "youtubeTitle": "Introduction to JavaScript — Coder Army",
  ...
  },
  {
    ...
    "youtubeUrl": "https://www.youtube.com/watch?v=UXYJGHhuGA8&list=PLQEaRBV9gAFuf-27K64l7-hV7o0fr9zx7",
    "youtubeTitle": "Variables & Data Types (var, let, const, mutable) — Coder Army",
    "paidLectureUrl": "https://rohittnegi.akamai.net.in/new-courses/18/content?activeTab=Content",
    "paidLectureLabel": "Full In-Depth Lecture — Thunder Course"
  },
  {
    ...
    "youtubeUrl": "https://www.youtube.com/watch?v=WRBFDQR0oM4&list=PLQEaRBV9gAFuf-27K64l7-hV7o0fr9zx7",
    "youtubeTitle": "Memory Management — Stack vs Heap — Coder Army",
    "paidLectureUrl": "https://rohittnegi.akamai.net.in/new-courses/18/content?activeTab=Content",
    "paidLectureLabel": "Full In-Depth Lecture — Thunder Course"
  },
  {
    ...
    "youtubeUrl": "https://www.youtube.com/watch?v=7dMQr2-T--4&list=PLQEaRBV9gAFuf-27K64l7-hV7o0fr9zx7",
    "youtubeTitle": "Conditionals, Loops & Operators — Coder Army",
  ...
  },
  {
    ...
    "sections": [
      ...
      {
        "id": "practice-level-1",
        "title": "Practice \u2014 Level 1 (Very Easy)",
        "content": "Warm-up loop drills. Try each yourself first, then check the solution.\n\n1. Print numbers 1 to 20\n2. Print numbers 20 to 1\n3. Print even numbers from 1 to 50\n4. Print odd numbers from 1 to 50\n5. Print multiples of 3 up to 30\n6. Print numbers divisible by 5 up to 100\n7. Print \"Coder Army\" 10 times\n8. Print squares of numbers from 1 to 10\n9. Print cubes of numbers from 1 to 10\n10. Print numbers from 100 to 0",
        "code": "// 1\nfor (let i = 1; i <= 20; i++) console.log(i);\n// 2\nfor (let i = 20; i >= 1; i--) console.log(i);\n// 3 even\nfor (let i = 2; i <= 50; i += 2) console.log(i);\n// 4 odd\nfor (let i = 1; i <= 50; i += 2) console.log(i);\n// 5 multiples of 3\nfor (let i = 3; i <= 30; i += 3) console.log(i);\n// 6 divisible by 5\nfor (let i = 5; i <= 100; i += 5) console.log(i);\n// 7\nfor (let i = 1; i <= 10; i++) console.log(\"Coder Army\");\n// 8 squares\nfor (let i = 1; i <= 10; i++) console.log(i * i);\n// 9 cubes\nfor (let i = 1; i <= 10; i++) console.log(i ** 3);\n// 10\nfor (let i = 100; i >= 0; i--) console.log(i);"
      },
      {
        "id": "practice-level-2",
        "title": "Practice \u2014 Level 2 (Dry Run & Thinking)",
        "content": "Digit and number problems \u2014 practice extracting digits with `% 10` and `Math.floor(n / 10)`.\n\n1. Find sum from 1 to 10\n2. Find sum from 1 to 100\n3. Find factorial of 5\n4. Find factorial of n\n5. Count digits in a number\n6. Reverse a number\n7. Check if a number is palindrome\n8. Find product of digits\n9. Find sum of digits\n10. Count how many even digits exist",
        "code": "// 1 sum 1-10\nlet s = 0; for (let i = 1; i <= 10; i++) s += i; console.log(s); // 55\n// 2 sum 1-100 (Gauss)\nconsole.log((100 * 101) / 2); // 5050\n// 3 factorial 5\nlet f = 1; for (let i = 1; i <= 5; i++) f *= i; console.log(f); // 120\n// 4 factorial of n\nfunction factorial(n) { let r = 1; for (let i = 2; i <= n; i++) r *= i; return r; }\n// 5 count digits\nfunction countDigits(n) { n = Math.abs(n); let c = 0; do { c++; n = Math.floor(n / 10); } while (n > 0); return c; }\n// 6 reverse a number\nfunction reverse(n) { let r = 0; while (n > 0) { r = r * 10 + (n % 10); n = Math.floor(n / 10); } return r; }\n// 7 palindrome number\nfunction isPalindrome(n) { return n === reverse(n); }\n// 8 product of digits\nfunction productDigits(n) { let p = 1; while (n > 0) { p *= n % 10; n = Math.floor(n / 10); } return p; }\n// 9 sum of digits\nfunction sumDigits(n) { let sum = 0; while (n > 0) { sum += n % 10; n = Math.floor(n / 10); } return sum; }\n// 10 count even digits\nfunction countEvenDigits(n) { let c = 0; while (n > 0) { if ((n % 10) % 2 === 0) c++; n = Math.floor(n / 10); } return c; }"
      },
      {
        "id": "practice-level-3",
        "title": "Practice \u2014 Level 3 (Conditions + Loops)",
        "content": "Number theory with conditions inside loops.\n\n1. Check if a number is prime\n2. Print all prime numbers from 1 to 100\n3. Find GCD of two numbers\n4. Find LCM of two numbers\n5. Check Armstrong number\n6. Check perfect number\n7. Find all divisors of a number\n8. Count divisors\n9. Find largest divisor (proper)\n10. Find smallest divisor greater than 1",
        "code": "// 1 prime check\nfunction isPrime(n) { if (n < 2) return false; for (let i = 2; i * i <= n; i++) if (n % i === 0) return false; return true; }\n// 2 primes 1-100\nfor (let i = 2; i <= 100; i++) if (isPrime(i)) console.log(i);\n// 3 GCD (Euclid)\nfunction gcd(a, b) { while (b) { [a, b] = [b, a % b]; } return a; }\n// 4 LCM\nfunction lcm(a, b) { return (a * b) / gcd(a, b); }\n// 5 Armstrong (n-digit)\nfunction isArmstrong(n) { const d = String(n).length; let sum = 0, x = n; while (x > 0) { sum += (x % 10) ** d; x = Math.floor(x / 10); } return sum === n; }\n// 6 perfect number\nfunction isPerfect(n) { let sum = 0; for (let i = 1; i < n; i++) if (n % i === 0) sum += i; return sum === n; }\n// 7 all divisors\nfunction divisors(n) { const r = []; for (let i = 1; i <= n; i++) if (n % i === 0) r.push(i); return r; }\n// 8 count divisors\nfunction countDivisors(n) { let c = 0; for (let i = 1; i <= n; i++) if (n % i === 0) c++; return c; }\n// 9 largest proper divisor\nfunction largestDivisor(n) { for (let i = Math.floor(n / 2); i >= 1; i--) if (n % i === 0) return i; return 1; }\n// 10 smallest divisor > 1\nfunction smallestDivisor(n) { for (let i = 2; i <= n; i++) if (n % i === 0) return i; return n; }"
      },
      {
        "id": "practice-level-4",
        "title": "Practice \u2014 Level 4 (Strings)",
        "content": "String traversal \u2014 loop over characters with `for (const ch of str)`.\n\n1. Count vowels\n2. Count consonants\n3. Count spaces\n4. Reverse a string\n5. Check palindrome string\n6. Count frequency of a character\n7. Remove vowels\n8. Convert lowercase to uppercase manually\n9. Count words\n10. Find longest word",
        "code": "// 1 count vowels\nfunction countVowels(s) { let c = 0; for (const ch of s.toLowerCase()) if (\"aeiou\".includes(ch)) c++; return c; }\n// 2 count consonants\nfunction countConsonants(s) { let c = 0; for (const ch of s.toLowerCase()) if (ch >= 'a' && ch <= 'z' && !\"aeiou\".includes(ch)) c++; return c; }\n// 3 count spaces\nfunction countSpaces(s) { let c = 0; for (const ch of s) if (ch === ' ') c++; return c; }\n// 4 reverse a string\nfunction reverseStr(s) { let r = \"\"; for (let i = s.length - 1; i >= 0; i--) r += s[i]; return r; }\n// 5 palindrome string\nfunction isPalindromeStr(s) { return s === reverseStr(s); }\n// 6 frequency of a character\nfunction charFreq(s, ch) { let c = 0; for (const x of s) if (x === ch) c++; return c; }\n// 7 remove vowels\nfunction removeVowels(s) { let r = \"\"; for (const ch of s) if (!\"aeiouAEIOU\".includes(ch)) r += ch; return r; }\n// 8 lower -> upper manually (A=65, a=97, diff 32)\nfunction toUpper(s) { let r = \"\"; for (const ch of s) { const c = ch.charCodeAt(0); r += (c >= 97 && c <= 122) ? String.fromCharCode(c - 32) : ch; } return r; }\n// 9 count words\nfunction countWords(s) { return s.trim().split(/\\s+/).length; }\n// 10 longest word\nfunction longestWord(s) { let best = \"\"; for (const w of s.split(\" \")) if (w.length > best.length) best = w; return best; }"
      },
      {
        "id": "practice-level-5",
        "title": "Practice \u2014 Level 5 (Arrays)",
        "content": "Array algorithms \u2014 the foundation of DSA.\n\n1. Find largest element\n2. Find smallest element\n3. Find second largest element\n4. Calculate array sum\n5. Calculate average\n6. Count even numbers\n7. Count odd numbers\n8. Reverse an array\n9. Find frequency of a number\n10. Search element using linear search",
        "code": "const arr = [5, 2, 9, 1, 7, 2];\n// 1 largest\nfunction maxOf(a) { let m = a[0]; for (const x of a) if (x > m) m = x; return m; }\n// 2 smallest\nfunction minOf(a) { let m = a[0]; for (const x of a) if (x < m) m = x; return m; }\n// 3 second largest\nfunction secondLargest(a) { let first = -Infinity, second = -Infinity; for (const x of a) { if (x > first) { second = first; first = x; } else if (x > second && x < first) second = x; } return second; }\n// 4 sum\nfunction sumArr(a) { let s = 0; for (const x of a) s += x; return s; }\n// 5 average\nfunction average(a) { return sumArr(a) / a.length; }\n// 6 count even\nfunction countEven(a) { let c = 0; for (const x of a) if (x % 2 === 0) c++; return c; }\n// 7 count odd\nfunction countOdd(a) { return a.length - countEven(a); }\n// 8 reverse array\nfunction reverseArr(a) { const r = []; for (let i = a.length - 1; i >= 0; i--) r.push(a[i]); return r; }\n// 9 frequency of a number\nfunction numFreq(a, n) { let c = 0; for (const x of a) if (x === n) c++; return c; }\n// 10 linear search -> index or -1\nfunction linearSearch(a, target) { for (let i = 0; i < a.length; i++) if (a[i] === target) return i; return -1; }"
      }
    ],
    "quiz": [
      {
    ...
    "youtubeUrl": "https://www.youtube.com/watch?v=HTcT-TuraHM&list=PLQEaRBV9gAFuf-27K64l7-hV7o0fr9zx7",
    "youtubeTitle": "Numbers & Math Object — Coder Army",
    "paidLectureUrl": "https://rohittnegi.akamai.net.in/new-courses/18/content?activeTab=Content",
    "paidLectureLabel": "Full In-Depth Lecture — Thunder Course"
  },
  {
    ...
    "youtubeUrl": "https://www.youtube.com/watch?v=8dgsUGEgPXo&list=PLQEaRBV9gAFuf-27K64l7-hV7o0fr9zx7",
    "youtubeTitle": "Strings & Dates In-Depth — Coder Army",
    "paidLectureUrl": "https://rohittnegi.akamai.net.in/new-courses/18/content?activeTab=Content",
    "paidLectureLabel": "Full In-Depth Lecture — Thunder Course"
  },
  {
    ...
    "youtubeUrl": "https://www.youtube.com/watch?v=fuA8BQkQO_E&list=PLQEaRBV9gAFuf-27K64l7-hV7o0fr9zx7",
    "youtubeTitle": "Arrays In-Depth — Coder Army",
    "paidLectureUrl": "https://rohittnegi.akamai.net.in/new-courses/18/content?activeTab=Content",
    "paidLectureLabel": "Full In-Depth Lecture — Thunder Course"
  },
  {
    ...
    "youtubeUrl": "https://www.youtube.com/watch?v=iuZkPCBBV5U&list=PLQEaRBV9gAFuf-27K64l7-hV7o0fr9zx7",
    "youtubeTitle": "Objects In-Depth — Coder Army",
    "paidLectureUrl": "https://rohittnegi.akamai.net.in/new-courses/18/content?activeTab=Content",
    "paidLectureLabel": "Full In-Depth Lecture — Thunder Course"
  },
  {
    ...
    "youtubeUrl": "https://www.youtube.com/watch?v=iY8LlFRLpXQ&list=PLQEaRBV9gAFuf-27K64l7-hV7o0fr9zx7",
    "youtubeTitle": "Functions In-Depth — Coder Army",
    "paidLectureUrl": "https://rohittnegi.akamai.net.in/new-courses/18/content?activeTab=Content",
    "paidLectureLabel": "Full In-Depth Lecture — Thunder Course"
  },
  {
    ...
    "youtubeUrl": "https://www.youtube.com/watch?v=ijPq-u3y9cs&list=PLQEaRBV9gAFuf-27K64l7-hV7o0fr9zx7",
    "youtubeTitle": "How JavaScript Runs & Hoisting — Coder Army",
    "paidLectureUrl": "https://rohittnegi.akamai.net.in/new-courses/18/content?activeTab=Content",
    "paidLectureLabel": "Full In-Depth Lecture — Thunder Course"
  },
  {
    ...
    "youtubeUrl": "https://www.youtube.com/watch?v=UBCPtXXMAWs&list=PLQEaRBV9gAFuf-27K64l7-hV7o0fr9zx7",
    "youtubeTitle": "Closures, Scope & Higher-Order Functions — Coder Army",
    "paidLectureUrl": "https://rohittnegi.akamai.net.in/new-courses/18/content?activeTab=Content",
    "paidLectureLabel": "Full In-Depth Lecture — Thunder Course"
  },
  {
    ...
    "youtubeUrl": "https://www.youtube.com/watch?v=UByPRYaMEkI&list=PLQEaRBV9gAFuf-27K64l7-hV7o0fr9zx7",
    "youtubeTitle": "Map, Filter, Reduce, Set & Map — Coder Army",
    "paidLectureUrl": "https://rohittnegi.akamai.net.in/new-courses/18/content?activeTab=Content",
    "paidLectureLabel": "Full In-Depth Lecture — Thunder Course"
  },
  {
    ...
    "youtubeUrl": "https://www.youtube.com/watch?v=wLp99HGG8GQ&list=PLQEaRBV9gAFuf-27K64l7-hV7o0fr9zx7",
    "youtubeTitle": "DOM Manipulation — The Document Object Model — Coder Army",
    "paidLectureUrl": "https://rohittnegi.akamai.net.in/new-courses/18/content?activeTab=Content",
    "paidLectureLabel": "Full In-Depth Lecture — Thunder Course"
  },
  {
    ...
    "youtubeUrl": "https://www.youtube.com/watch?v=2jVOkYiAl2s&list=PLQEaRBV9gAFuf-27K64l7-hV7o0fr9zx7",
    "youtubeTitle": "CRUD Operations in the DOM — Coder Army",
    "paidLectureUrl": "https://rohittnegi.akamai.net.in/new-courses/18/content?activeTab=Content",
    "paidLectureLabel": "Full In-Depth Lecture — Thunder Course"
  },
  {
    ...
    "youtubeUrl": "https://www.youtube.com/watch?v=CGjHpnm8TeE&list=PLQEaRBV9gAFuf-27K64l7-hV7o0fr9zx7",
    "youtubeTitle": "Events & Event Handlers — Coder Army",
    "paidLectureUrl": "https://rohittnegi.akamai.net.in/new-courses/18/content?activeTab=Content",
    "paidLectureLabel": "Full In-Depth Lecture — Thunder Course"
  },
  {
    ...
    "youtubeUrl": "https://www.youtube.com/watch?v=dQDteO0RXrc&list=PLQEaRBV9gAFuf-27K64l7-hV7o0fr9zx7",
    "youtubeTitle": "10 JavaScript Projects for Beginners — Coder Army",
    "paidLectureUrl": "https://rohittnegi.akamai.net.in/new-courses/18/content?activeTab=Content",
    "paidLectureLabel": "Full In-Depth Lecture — Thunder Course",
  ...
  },
  {
    ...
    "youtubeUrl": "https://www.youtube.com/watch?v=rsepF1ugeC8&list=PLQEaRBV9gAFuf-27K64l7-hV7o0fr9zx7",
    "youtubeTitle": "Event Loop — Why JS is Single-Threaded — Coder Army",
    "youtubeSupplementUrl": "https://www.youtube.com/watch?v=8aGhZQkoFbQ",
    "youtubeSupplementTitle": "What the heck is the event loop anyway? — Philip Roberts · JSConf",
    "paidLectureUrl": "https://rohittnegi.akamai.net.in/new-courses/18/content?activeTab=Content",
    "paidLectureLabel": "Full In-Depth Lecture — Thunder Course"
  },
  {
    ...
    "youtubeUrl": "https://www.youtube.com/watch?v=CTJLBCYod9E&list=PLQEaRBV9gAFuf-27K64l7-hV7o0fr9zx7",
    "youtubeTitle": "Callback Hell & Async Programming — Coder Army",
    "paidLectureUrl": "https://rohittnegi.akamai.net.in/new-courses/18/content?activeTab=Content",
    "paidLectureLabel": "Full In-Depth Lecture — Thunder Course"
  },
  {
    ...
    "youtubeUrl": "https://www.youtube.com/watch?v=LYe1my0KkPo&list=PLQEaRBV9gAFuf-27K64l7-hV7o0fr9zx7",
    "youtubeTitle": "Promises & JSON vs JS Object — Coder Army",
