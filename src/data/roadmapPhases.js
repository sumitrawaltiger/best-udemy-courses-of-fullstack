...
// Journey Day 1 = 24 Jul 2026; last day = 23 Jul 2030. Study 5:00–8:00 AM (3 hrs/day), 4 AM wake-up.
...
export const ROADMAP_ARCS = [
  {
    ...
    blurb: 'Starts with TypeScript (HTML5, CSS3 & JavaScript are assumed prerequisites), then React, Next.js, React Native, Node/Express, plus Agentic AI, DSA & system design — all in JavaScript.',
  },
  {
    id: 'y2',
  ...
  },
  {
    ...
    blurb: 'Spring Boot, microservices, and design patterns, plus Agentic AI, with DSA & system design practiced in Java.',
  },
  {
    id: 'y4',
...
export const ROADMAP_PHASES = [
  // ---------------- Year 1 · TypeScript Stack ----------------
  {
    n: 1, arc: 'y1', icon: '🔷',
    title: 'TypeScript',
    window: '24 Jul – 31 Oct 2026', days: 100, dayRange: 'Days 1–100',
  ...
  },
  {
    n: 2, arc: 'y1', icon: '⚛️',
    title: 'React & Next.js',
    window: '1 Nov – 20 Dec 2026', days: 50, dayRange: 'Days 101–150',
    source: 'Udemy · Anil Dollor', to: '/nextjs',
  },
  {
    n: 3, arc: 'y1', icon: '📱',
    title: 'React Native',
    window: '21 Dec 2026 – 29 Jan 2027', days: 40, dayRange: 'Days 151–190',
    source: 'ChaiCode Mobile Cohort', to: '/mobile',
  },
  {
    n: 4, arc: 'y1', icon: '🟢',
    title: 'Express / Node.js',
    window: '30 Jan – 23 Feb 2027', days: 25, dayRange: 'Days 191–215',
    source: 'Thunder++ · Rohit Negi', to: '/',
  },
  {
    n: 5, arc: 'y1', icon: '🧠',
    title: 'DSA in JavaScript',
    window: '24 Feb – 3 Jun 2027', days: 100, dayRange: 'Days 216–315',
  ...
  },
  {
    ...
    window: '4 Jun – 23 Jul 2027', days: 50, dayRange: 'Days 316–365',
  ...
  // ---------------- Year 2 · Python Stack ----------------
  {
    n: 7, arc: 'y2', icon: '🐍',
    title: 'Python',
    window: '24 Jul – 31 Oct 2027', days: 100, dayRange: 'Days 366–465',
    source: 'Udemy · Dr. Angela Yu', to: '/python',
  },
  {
    n: 8, arc: 'y2', icon: '🎸',
    title: 'Django',
    window: '1 Nov 2027 – 5 Jan 2028', days: 66, dayRange: 'Days 466–531',
    source: 'Udemy',
  ...
  },
  {
    ...
    window: '6 Jan 2028 – 24 Feb 2028', days: 50, dayRange: 'Days 532–581',
    source: 'Ashok IT / Piyush Garg', to: '/python',
  },
  {
    n: 10, arc: 'y2', icon: '🧠',
    title: 'DSA in Python',
    window: '25 Feb – 3 Jun 2028', days: 100, dayRange: 'Days 582–681',
    source: 'Udemy / ChaiCode', to: '/interview',
  },
  {
    n: 11, arc: 'y2', icon: '🏗️',
    title: 'System Design in Python',
    window: '4 Jun – 23 Jul 2028', days: 50, dayRange: 'Days 682–731',
    source: 'ChaiCode + GeeksForGeeks', to: '/interview',
  },
  // ---------------- Year 3 · Java Stack ----------------
  {
    ...
    window: '24 Jul – 31 Oct 2028', days: 100, dayRange: 'Days 732–831',
    source: 'Udemy', to: '/java',
  },
  {
    n: 13, arc: 'y3', icon: '🧩',
    title: 'Microservices',
    window: '1 Nov – 30 Dec 2028', days: 60, dayRange: 'Days 832–891',
    source: 'Udemy', to: '/java',
  },
  {
    n: 14, arc: 'y3', icon: '📐',
    title: 'Java Design Patterns',
    window: '31 Dec 2028 – 13 Feb 2029', days: 45, dayRange: 'Days 892–936',
    source: 'Udemy', to: '/java',
  },
  {
    n: 15, arc: 'y3', icon: '🧠',
    title: 'DSA in Java',
    window: '14 Feb – 24 May 2029', days: 100, dayRange: 'Days 937–1036',
  ...
  },
  {
    ...
    window: '25 May – 23 Jul 2029', days: 60, dayRange: 'Days 1037–1096',
    source: 'ChaiCode + GeeksForGeeks', to: '/interview',
  },
  // ---------------- Year 4 · DevOps & Cloud ----------------
  {
    n: 17, arc: 'y4', icon: '☁️',
    title: 'AWS Cloud',
    window: '24 Jul – 31 Oct 2029', days: 100, dayRange: 'Days 1097–1196',
    source: 'CloudFolksHub / KodeKloud', to: '/aws',
  },
  {
    n: 18, arc: 'y4', icon: '🐳',
    title: 'Docker',
    window: '1 Nov – 10 Dec 2029', days: 40, dayRange: 'Days 1197–1236',
    source: 'Udemy / KodeKloud', to: '/k8s',
  },
  {
    n: 19, arc: 'y4', icon: '☸️',
    title: 'Kubernetes',
    window: '11 Dec 2029 – 20 Mar 2030', days: 100, dayRange: 'Days 1237–1336',
    source: 'Udemy / KodeKloud', to: '/k8s',
  },
  {
    n: 20, arc: 'y4', icon: '⚙️', final: true,
    title: 'DevOps & CI/CD',
    window: '21 Mar – 23 Jul 2030', days: 125, dayRange: 'Days 1337–1461',
