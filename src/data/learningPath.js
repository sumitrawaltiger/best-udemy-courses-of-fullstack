export const LEARNING_PATH = [
  ...
  { id: 'devops', label: '100 Days of DevOps', short: 'DO', desc: 'CI/CD — KodeKloud', path: '/devops' },
  { id: 'k8s', label: 'Kubernetes', short: 'K8s', desc: '100 days — CKA path', path: '/k8s' },
  { id: 'interview', label: 'DSA & Interview', short: 'IP', desc: '60 modules — ChaiCode + GfG', path: '/interview' },
];
